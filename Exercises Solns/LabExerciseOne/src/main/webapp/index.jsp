...
<form id="detailsForm" name="detailsForm" method="post" action="handleForm.jsp">
  ...
  <table width="730" border="0">
    ...
    <tr>
      ...
      <td><p>
        <label>
          <label>EU</label> <input type="radio" id="eu" name="eu" value="eu" <%=(c.getEu().equals("eu") ? "checked":"")%> >
          <label>Non EU</label> <input type="radio" id="eu" name="eu" value="noneu" <%=(c.getEu().equals("noneu") ? "checked":"")%> >
