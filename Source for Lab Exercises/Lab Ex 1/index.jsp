...
<form id="detailsForm" name="detailsForm" method="???" action="????">
  ...
  <table width="730" border="0">
    <tr>
      ...
      <td width="454"><input name="name" type="text" id="name" size="50" value="" /></td>
    </tr>
    <tr>
      <td height="31">Address</td>
      <td><input name="address" type="text" id="address" size="50" value="" /></td>
    </tr>
    <tr>
      <td>City</td>
    ...
    <tr>
      ...
      <td><p>
        <label>
          <label>EU</label> <input type="radio" id="eu" name="eu" value="eu" >
          <label>Non EU</label> <input type="radio" id="eu" name="eu" value="noneu" >
